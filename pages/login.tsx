...
const login = () => {
    ...
    const submitInfo = async (e: any) => {
        ...
        var hello = await fetch('http://localhost:3000/api/UserData/Login', {
            method: 'POST', // or 'PUT'
            headers: {
            ...
            <section>
                <div className="flex flex-col justify-center min- py-12 sm:px-6 lg:px-8">
                    <div className="flex flex-col text-center sm:mx-auto sm:w-full sm:max-w-md">
                        ...
                        <div className='text-gray-500 text-sm mt-3'>OR  <Link href={'/signup'} className='text-blue-600 underline ml-1'>Sign Up</Link></div>
                    </div>
                        ...
                        <div className="px-4 py-8 sm:px-10">
                            <form className="space-y-6" onSubmit={submitInfo} method="POST">
                                ...
                                <div>
                                    ...
                                    <div className="mt-1">
                                        <input onChange={handleChange} value={password} id="password" name="password" type="password" autoComplete="current-password" required={true} className="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300" />
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="text-sm">
                                        <a href="/forget" className="font-medium text-blue-600 hover:text-blue-500"> Forgot your password? </a>
                                    </div>
                                </div>
